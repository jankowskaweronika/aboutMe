...
function mShotsPreview(url: string, width = 1200): string {
  // Public website screenshot endpoint (no API key). Good enough for portfolio thumbnails.
...
export const pricingContent = {
  ...
  packages: [
    ...
    },
    {
      id: 'longform',
      packTag: 'Montaż',
      quoteTitle: 'Dłuższy format, lepsze tempo',
      name: 'Montaż dłuższych formatów',
      features: [
        'Montaż vlogów, YouTube (long form) i materiałów z eventów',
        'Cięcie, dynamika, czyszczenie audio i podstawowa korekcja',
        'Wstawki, napisy, przebitki i porządek narracji',
      ],
      priceFrom: 'od 300 PLN / materiał',
      note: 'Wycena zależy od długości surowego materiału i zakresu dodatków.',
      ctaLabel: 'Zapytaj o wycenę',
      ctaHref: gmailComposeUrl(CONTACT_EMAIL, 'Brief na dłuższy montaż'),
    },
...
export const portfolioSites: PortfolioSite[] = [
  {
    ...
    subtitle: 'Strona sprzedażowa',
    url: 'https://akademiasamouka.pl/',
    previewImage: `${import.meta.env.BASE_URL}portfolio/akademia-samouka.png?v=1`,
    cardGradient:
      'linear-gradient(135deg, #8b4d5c 0%, #c56b5c 40%, #f0c09a 75%, #f5ddd4 100%)',
  },
  {
    id: '2',
    title: 'Stajnia Złota Podkowa',
    subtitle: 'Strona www',
    url: 'http://stajniazlotapodkowa.pl/',
    previewImage: `${import.meta.env.BASE_URL}portfolio/stajnia-zlota-podkowa.png?v=1`,
    cardGradient:
      'linear-gradient(135deg, #6b4f63 0%, #8fa985 42%, #c5d4c0 70%, #fce8dc 100%)',
  },
  {
    id: '3',
    title: 'Kurs front-end od A do Z',
    subtitle: 'Strona sprzedażowa',
    url: 'https://coderoad.thinkific.com/bundles/kurs-front-end-od-a-do-z',
    previewImage: mShotsPreview('https://coderoad.thinkific.com/bundles/kurs-front-end-od-a-do-z'),
    cardGradient:
